...
CaptchaJS.versioning = "Beta v0.1.1"
...
CaptchaJS.captchafont = "25px Georgia"
...
function init(){
    ...
    ct = document.getElementsByTagName("captcha")[0]
    ct.insertAdjacentHTML('beforeend', '<div id = "cjsmain" style = "background-color: white;max-width: max-content;max-height: max-content;background-color: #663737;border: lime;border-width: 3px;border-style: solid;border-radius: 10px;width: 290px;"> <div id = "ctpimgholder" style = "margin: 5px;"> <center> <canvas id = "cjsimg" width="200" height="50" style="z-index: 4;">Your Browser Doesnt Support JS</canvas> </center> </div> <div id = "ctpvalidator" style="display: flex;flex-direction: row;"> <input placeholder="CAPTCHA" id = "ip-captcha" style = "outline: none;padding: 10px 20px;margin: 8px 0;box-sizing: border-box;background-color: white;color: black;border-color:crimson;width:180px;"> <span style = "display: flex;flex-direction: column;width:28px;"><span onclick = "master();" style = "color: blue;font-size: 20px;margin: 0%;padding: 0%;">🔄</span><span onclick = "verifycptc();" style = "color: green;font-size: 20px;margin: 0%;padding: 0%;">✔️</span></span> </div> </div>')
